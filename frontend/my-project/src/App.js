...
import EntrepriseList, {
  EntrepriseListLayout,
} from "./Components/entreprise/Pages/ListEntreprise";
        ...
        <div className="App">
          <Routes>
            ...
            <Route path="/enseignant" element={<EnseignantLayout />}>
              ...
              <Route
                path="groupes/:id/rendez-vous"
                element={<RendezVousPage />}
              />
              <Route
                path="themes/:id"
                element={<ThemeEnseignant link={"enseignant"} />}
              />
            ...
            <Route path="/entreprise" element={<EntrepriseLayout />}>
              ...
              <Route
                path="themes/:id"
                element={<ThemeEnseignant link={"entreprise"} />}
              />
            </Route>
          </Routes>
