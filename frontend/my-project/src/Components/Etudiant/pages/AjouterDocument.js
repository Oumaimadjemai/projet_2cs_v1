            ...
            <div className="ajouter-enseignant-wrapper">
                ...
                <form id='ajouterFormEnseignant' onSubmit={handleSubmit}>
                            ...
                            <label 
                                ...
                                className="flex items-center  text-sm font-medium text-gray-700 mb-2 mr-10"
                            >
                                {t('name')}
                            </label>
                            <input
                                ...
                                placeholder={t('entre name document')}
                                required
                                className="w-[20rem] px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            />
                            </div>
