...
import { AjouterTheme } from '../Components/AjouterTheme';
...
export const EntrepriseThemesContext = createContext();

function ThemesEntreprise() {
    ...
    return (
        <EntrepriseThemesContext.Provider value={{ setThemes, setLoading }}>
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    ...
                                                                    <span style={{
                                                                        ...
                                                                        onClick={() => navigate(`/entreprise/themes/${theme.id}`)}
                                                                    >
                                                                        Voir Plus
        ...
        </EntrepriseThemesContext.Provider>
    )
}

export default ThemesEntreprise
...
const ThemeCard = ({ id, title, annee, specialite, statut }) => {
    ...
    return (
        <div className="theme-card" onClick={() => navigate(`/entreprise/themes/${id}`)}>
